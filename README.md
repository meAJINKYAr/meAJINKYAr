...
flowchart LR
  subgraph Frontend
    A[React / Vue] --> B[API Gateway]
  end
  subgraph Backend
    B --> C[Node.js / Python services]
    C --> D[(SQL Database)]
    C --> E[AWS S3 / Storage]
    C --> F[AWS Lambda / Serverless]
  end
  subgraph AI
    C --> G[AI Models / Inference]
  end
  style Frontend fill:#f7f9fc,stroke:#e2e8f0
...
## 📈 GitHub stats
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=meAJINKYAr&layout=compact&theme=tokyonight)](https://github.com/meAJINKYAr)
[![GitHub stats](https://github-readme-stats.vercel.app/api?username=meAJINKYAr&show_icons=true&theme=tokyonight)](https://github.com/meAJINKYAr)
